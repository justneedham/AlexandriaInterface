...
class Controller(object):
    ...
    def loadTestData(self):
        data = TestData()
        self.data = {
            'Views': {'Orders': data.loadTestOrderView(), 'Customers': data.loadTestCustomerView()},
            'Data': {'Orders': data.loadOrders(), 'Customers': []}
        }
...
if __name__ == '__main__':
    ...
    Alexandria.mainWindow.setStyleSheet("""
        QWidget
        {
            color: #eff0f1;
